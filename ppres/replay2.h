...
enum command_number {
	...
	WORKER_TRACE_ADDRESS = 0x123a,
	WORKER_THREAD_STATE = 0x123b,
	WORKER_REPLAY_STATE = 0x123c,
	WORKER_CONTROL_TRACE = 0x123d,
	WORKER_GET_MEMORY = 0x123e,
	WORKER_VG_INTERMEDIATE = 0x123f,
